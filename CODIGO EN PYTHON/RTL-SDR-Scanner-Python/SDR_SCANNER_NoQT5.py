...
class ScannerApp:
    def __init__(self, ppm = 5, gain = 25, threshold = 0.4, lnb_lo = -125000000, start = 87000000, stop = 108500000, step = 100000, city = 'CALDAS'):
        self.ppm = ppm
        self.gain = gain
    ...
    def scan(self):
        ...
        station_verification(radio, self.city, "C:\\Users\\ASUS\\Documents\\GitHub\\ANE\\channels-534_radioemisoras.csv")
