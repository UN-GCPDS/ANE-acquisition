...
sdr_center_freq = 105.7e6

sdr.center_freq = sdr_center_freq
sdr.sample_rate = sdr_sample_rate

samples_hack = hackrf.read_samples(20000000)
samples_sdr = sdr.read_samples(4800000)
...
audio_sdr = fm_audio(samples_sdr, sdr_sample_rate, sdr_center_freq, plot=False)
