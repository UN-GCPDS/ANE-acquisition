...
import sip
import threading
import top_block_python as python  # embedded python module
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Freq = Freq = python.sweeper(fun_prob)
        self.volume = volume = -6
        self.samp_rate = samp_rate = 1024000
        self.radio_freq = radio_freq = 95100000
        ...
        self.rational_resampler_xxx_0_0 = filter.rational_resampler_fff(
                ...
                taps=[],
                fractional_bw=0)
        self._radio_freq_range = Range(88000000, 108000000, 100000, 95100000, 200)
        self._radio_freq_win = RangeWidget(self._radio_freq_range, self.set_radio_freq, "Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._radio_freq_win)
    ...
    def set_fun_prob(self, fun_prob):
        ...
        self.set_Freq(python.sweeper(self.fun_prob))
